...
const Tabs = React.forwardRef(({ className, value, onValueChange, children, ...props }, ref) => {
    // Determine active tab from context or props? 
    // For simplicity without Radix context, we'll use a simple controlled component pattern or Context.
    // Let's use flexible Context.
    return (
